...
public class SimpleView20180913Q1NicoleMcElroy {
	// Use Part Descriptor's ID in fragment.e4xmi.
	public static final String VIEW_ID = "project-20180913-q1-nicole-mcelroy.partdescriptor.simpleview20180913q1nicolemcelroy";
	// Use Popup Menu's ID in fragment.e4xmi.
	public final static String POPUPMENU_ID = "project-20180913-q1-nicole-mcelroy.popupmenu.reverse";
	// Text box object.
	private StyledText styledText = null;

	@Inject
	public SimpleView20180913Q1NicoleMcElroy() {
	}

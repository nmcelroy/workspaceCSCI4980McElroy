...
public class SimpleView {
	...
	public static final String VIEW_ID = "project0830-part-desc-example-mcelroy.partdescriptor.simpleview1example";
	// Use Popup Menu's ID in fragment.e4xmi.
	public final static String POPUPMENU_ID = "project0830-part-desc-example-mcelroy.popupmenu.mypopupmenu";
	// Text box object.

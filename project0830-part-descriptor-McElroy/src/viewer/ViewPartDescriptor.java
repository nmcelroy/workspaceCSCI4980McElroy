...
public class ViewPartDescriptor {
	...
	public static final String VIEW_ID = "project0830-part-descriptor-mcelroy.partdescriptor.viewpartdescriptor";
	// Use Popup Menu's ID in fragment.e4xmi.
	public final static String POPUPMENU_ID = "project0830-part-descriptor-mcelroy.popupmenu.mymenu";
	// Text box object.
